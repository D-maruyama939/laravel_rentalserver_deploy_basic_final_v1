...
@section('content')
    ...
    <div class="user_show">
        ...
        <div class="card mb-4">
            <h4 class="card-header container pt-0">
                <div class="row mt-4">
                    ...
                    <div class="col-6 col-md-3 text-right">
                        @if(Auth::user()->id !== $user->id)
                            ...
                            @endif
                        @else
                            <a class="btn btn-info" href="{{ route('profile.edit', Auth::user()) }}">編集</a>
                        @endif
                    </div>
                </div>
            </h4>
            ...
            <div class="card-footer">
                ...
                {{ $user->prefecture->prefecture }} / {{ $user->getAgeGroup($user) }}
            </div>
        </div>
